...
class DriveBase(object):
    ...
    async def gyroForwards(self, distance: float, startSpeed: int, endSpeed: int, *, kp: float = 0.5, ki: float = 0.2, kd: float = 0.75, dt: int = 1, integralLimit: int = 250, stallDetectionIterator: int = 5000, stallDetectionThreshold: int = 5, accelerationScale: int = 100, accelerationMethod = SpeedMethods.liniar, stop: bool = True) -> None:
    ...
    async def gyroBackwards(self, distance: float, startSpeed: int, endSpeed: int, *, kp: float = 0.5, ki: float = 0.2, kd: float = 0.75, dt: int = 1, integralLimit: int = 250, stallDetectionIterator: int = 5000, stallDetectionThreshold: int = 5, accelerationScale: int = 100, accelerationMethod = SpeedMethods.liniar, stop: bool = True) -> None:
    ...
    async def turnLeft(self, angle: float, startSpeed: int, endSpeed: int, *, kLeft: float = -1, kRight: float = 1, stallDetectionIterator: int = 5000, stallDetectionThreshold: int = 2, accelerationScale: int = 100, accelerationMethod = SpeedMethods.liniar, addition: int = 0, divizor: int = 1, stop: bool = True):
    ...
    async def turnRight(self, angle: float, startSpeed: int, endSpeed: int, *, kLeft: float = 1, kRight: float = -1, stallDetectionIterator: int = 5000, stallDetectionThreshold: int = 2, accelerationScale: int = 100, accelerationMethod = SpeedMethods.liniar, addition: int = 0, divizor: int = 1, stop: bool = True):
