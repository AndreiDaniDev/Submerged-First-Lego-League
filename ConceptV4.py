...
async def gyroBackwards(speed: int, distance: float, target: int = 0, *, kp: float = 0.4, ki: float = 0.2, kd: float = 0.001, dt : int = 5, lastError: float = 0, lastIntegral: float = 0, trajectory: int = 0, stop: bool = True, reset: bool = True, tresholdStallDetection: int = 10):
    # ---> Needed to know <------> Documentation <---
    '''
        speed - the speed that is applied on the wheel's of the robot
        distance (cm) - the distance that the robot will travel
