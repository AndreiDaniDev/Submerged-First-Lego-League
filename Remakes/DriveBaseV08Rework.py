...
class DriveBase(object):
    ...
    async def turnLeft(self, angle: int, startSpeed: int, endSpeed: int, *, kLeft: int = -1, kRight: int = 1, error: int = 50, stallDetectionIterator: int = 2000, stallDetectionThreshold: int = 5, accelerationScale: int = 100, accelerationMethod = SpeedMethods.easeOutInQuad, addition: int = 0, divizor: int = 1, stop: bool = True):
        ...
        if(angle > self.maxOneTurnAngle):
            await self.turnLeft(angle // 3, startSpeed, endSpeed, kLeft = kLeft, kRight = kRight, error = error, stallDetectionIterator = stallDetectionIterator, stallDetectionThreshold = stallDetectionThreshold, accelerationScale = accelerationScale // 3, accelerationScale = accelerationScale // 3, accelerationMethod = accelerationMethod, addition = 0, divizor = 3, stop = False)
            await self.turnLeft(angle // 3, startSpeed, endSpeed, kLeft = kLeft, kRight = kRight, error = error, stallDetectionIterator = stallDetectionIterator, stallDetectionThreshold = stallDetectionThreshold, accelerationScale = accelerationScale // 3, accelerationScale = accelerationScale // 3, accelerationMethod = accelerationMethod, addition = 1, divizor = 3, stop = False)
            await self.turnLeft(angle // 3, startSpeed, endSpeed, kLeft = kLeft, kRight = kRight, error = error, stallDetectionIterator = stallDetectionIterator, stallDetectionThreshold = stallDetectionThreshold, accelerationScale = accelerationScale // 3, accelerationScale = accelerationScale // 3, accelerationMethod = accelerationMethod, addition = 2, divizor = 3, stop = stop)
            return None
    ...
    async def turnRight(self, angle: int, startSpeed: int, endSpeed: int, *, kLeft: int = 1, kRight: int = -1, error: int = 50, stallDetectionIterator: int = 2000, stallDetectionThreshold: int = 5, accelerationScale: int = 100, accelerationMethod = SpeedMethods.easeOutInQuad, addition: int = 0, divizor: int = 1, stop: bool = True):
        ...
        if(angle > self.maxOneTurnAngle):
            await self.turnRight(angle // 3, startSpeed, endSpeed, kLeft = kLeft, kRight = kRight, error = error, stallDetectionIterator = stallDetectionIterator, stallDetectionThreshold = stallDetectionThreshold, accelerationScale = accelerationScale // 3, accelerationScale = accelerationScale // 3, accelerationMethod = accelerationMethod, addition = 0, divizor = 3, stop = False)
            await self.turnRight(angle // 3, startSpeed, endSpeed, kLeft = kLeft, kRight = kRight, error = error, stallDetectionIterator = stallDetectionIterator, stallDetectionThreshold = stallDetectionThreshold, accelerationScale = accelerationScale // 3, accelerationScale = accelerationScale // 3, accelerationMethod = accelerationMethod, addition = 1, divizor = 3, stop = False)
            await self.turnRight(angle // 3, startSpeed, endSpeed, kLeft = kLeft, kRight = kRight, error = error, stallDetectionIterator = stallDetectionIterator, stallDetectionThreshold = stallDetectionThreshold, accelerationScale = accelerationScale // 3, accelerationScale = accelerationScale // 3, accelerationMethod = accelerationMethod, addition = 2, divizor = 3, stop = stop)
            return None
